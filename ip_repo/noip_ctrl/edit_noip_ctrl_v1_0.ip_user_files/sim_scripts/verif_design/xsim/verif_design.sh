...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_17 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot verif_design xil_defaultlib.verif_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim verif_design -key {Behavioral:sim_1:Functional:verif_design} -tclbatch cmd.tcl -protoinst "protoinst_files/verif_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb verif_design.wdb xsim.dir libdpi.so)
