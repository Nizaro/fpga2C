...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_10 -L xlconcat_v2_1_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bd_test xil_defaultlib.bd_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bd_test -key {Behavioral:sim_1:Functional:bd_test} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bd_test.wdb xsim.dir libdpi.so)
