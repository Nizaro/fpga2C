...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/ec67/hdl" +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/ec67/hdl" +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.verif_design xil_defaultlib.glbl -o verif_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./verif_design_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nothon/fpga2C/ip_repo/noip_ctrl/edit_noip_ctrl_v1_0.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key verif_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc verif_design_simv.daidir vcs_lib c.obj)
