...
set C_modelArgList {
	...
	{ HwReg_layerWidth_2_val_c int 16 regular {fifo 1}  }
	{ HwReg_layerHeight_2_val_c int 16 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer2Rgb", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_layerWidth_2_val_c", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_layerHeight_2_val_c", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ srcLayer2x_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ srcLayer2x_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ srcLayer2x_full_n sc_in sc_logic 1 signal 4 } 
	{ srcLayer2x_write sc_out sc_logic 1 signal 4 } 
	{ HwReg_layerWidth_2_val_c_din sc_out sc_lv 16 signal 5 } 
	{ HwReg_layerWidth_2_val_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_layerWidth_2_val_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_layerWidth_2_val_c_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_layerWidth_2_val_c_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_layerHeight_2_val_c_din sc_out sc_lv 16 signal 6 } 
	{ HwReg_layerHeight_2_val_c_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ HwReg_layerHeight_2_val_c_fifo_cap sc_in sc_lv 3 signal 6 } 
	{ HwReg_layerHeight_2_val_c_full_n sc_in sc_logic 1 signal 6 } 
	{ HwReg_layerHeight_2_val_c_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_layerWidth_2_val_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "HwReg_layerWidth_2_val_c", "role": "din" }} , 
 	{ "name": "HwReg_layerWidth_2_val_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerWidth_2_val_c", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_layerWidth_2_val_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerWidth_2_val_c", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_layerWidth_2_val_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerWidth_2_val_c", "role": "full_n" }} , 
 	{ "name": "HwReg_layerWidth_2_val_c_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerWidth_2_val_c", "role": "write" }} , 
 	{ "name": "HwReg_layerHeight_2_val_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "HwReg_layerHeight_2_val_c", "role": "din" }} , 
 	{ "name": "HwReg_layerHeight_2_val_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerHeight_2_val_c", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_layerHeight_2_val_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerHeight_2_val_c", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_layerHeight_2_val_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerHeight_2_val_c", "role": "full_n" }} , 
 	{ "name": "HwReg_layerHeight_2_val_c_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerHeight_2_val_c", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "srcLayer2Rgb", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2_fu_98", "Port" : "srcLayer2Rgb", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer2x", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2_fu_98", "Port" : "srcLayer2x", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "HwReg_layerWidth_2_val_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "HwReg_layerWidth_2_val_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "HwReg_layerHeight_2_val_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2_fu_98", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2_fu_98.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer2Rgb { ap_fifo {  { srcLayer2Rgb_dout fifo_data_in 0 24 }  { srcLayer2Rgb_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer2Rgb_fifo_cap fifo_update 0 3 }  { srcLayer2Rgb_empty_n fifo_status 0 1 }  { srcLayer2Rgb_read fifo_port_we 1 1 } } }
	...
	srcLayer2x { ap_fifo {  { srcLayer2x_din fifo_data_in 1 24 }  { srcLayer2x_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer2x_fifo_cap fifo_update 0 3 }  { srcLayer2x_full_n fifo_status 0 1 }  { srcLayer2x_write fifo_port_we 1 1 } } }
	HwReg_layerWidth_2_val_c { ap_fifo {  { HwReg_layerWidth_2_val_c_din fifo_data_in 1 16 }  { HwReg_layerWidth_2_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerWidth_2_val_c_fifo_cap fifo_update 0 3 }  { HwReg_layerWidth_2_val_c_full_n fifo_status 0 1 }  { HwReg_layerWidth_2_val_c_write fifo_port_we 1 1 } } }
	HwReg_layerHeight_2_val_c { ap_fifo {  { HwReg_layerHeight_2_val_c_din fifo_data_in 1 16 }  { HwReg_layerHeight_2_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerHeight_2_val_c_fifo_cap fifo_update 0 3 }  { HwReg_layerHeight_2_val_c_full_n fifo_status 0 1 }  { HwReg_layerHeight_2_val_c_write fifo_port_we 1 1 } } }
}
