...
#ifndef _main_design_monitor0_slice1_1_core_h_
#define _main_design_monitor0_slice1_1_core_h_

#include <systemc.h>
#include "properties.h"


class main_design_monitor0_slice1_1_core : public sc_module 
{
    public: 
       main_design_monitor0_slice1_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(main_design_monitor0_slice1_1_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~main_design_monitor0_slice1_1_core() = default;
