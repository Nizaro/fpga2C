...
#
# Script generated by Vivado on Mon Jul 15 10:00:35 CEST 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : verif_design.sh
...
#
# Usage        : verif_design.sh
#                verif_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                verif_design.sh [-reset_run]
#                verif_design.sh [-reset_log]
#                verif_design.sh [-help]
#
...
#                script (type 'verif_design.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "verif_design.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./verif_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/ec67/hdl" +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/ec67/hdl" +incdir+"../../../../edit_noip_ctrl_v1_0.gen/sources_1/bd/verif_design/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.verif_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.verif_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nothon/fpga2C/ip_repo/noip_ctrl/edit_noip_ctrl_v1_0.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log verif_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./verif_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: verif_design.sh [-help]\n\
Usage: verif_design.sh [-step]\n\
Usage: verif_design.sh [-lib_map_path]\n\
Usage: verif_design.sh [-reset_run]\n\
Usage: verif_design.sh [-reset_log]\n\
Usage: verif_design.sh [-keep_index]\n\
Usage: verif_design.sh [-noclean_files]\n\n\
