...
set C_modelArgList {
	...
	{ HwReg_layerEnableFlag_0_val_c int 1 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer0Yuv422", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_layerEnableFlag_0_val_c", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ srcLayer0Yuv_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ srcLayer0Yuv_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ srcLayer0Yuv_full_n sc_in sc_logic 1 signal 4 } 
	{ srcLayer0Yuv_write sc_out sc_logic 1 signal 4 } 
	{ HwReg_layerEnableFlag_0_val_c_din sc_out sc_lv 1 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_layerEnableFlag_0_val_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c", "role": "din" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c", "role": "full_n" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0Yuv422", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_94", "Port" : "srcLayer0Yuv422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer0Yuv", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_94", "Port" : "srcLayer0Yuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "HwReg_layerEnableFlag_0_val_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_94", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_94.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0Yuv422 { ap_fifo {  { srcLayer0Yuv422_dout fifo_data_in 0 24 }  { srcLayer0Yuv422_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0Yuv422_fifo_cap fifo_update 0 3 }  { srcLayer0Yuv422_empty_n fifo_status 0 1 }  { srcLayer0Yuv422_read fifo_port_we 1 1 } } }
	...
	srcLayer0Yuv { ap_fifo {  { srcLayer0Yuv_din fifo_data_in 1 24 }  { srcLayer0Yuv_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0Yuv_fifo_cap fifo_update 0 3 }  { srcLayer0Yuv_full_n fifo_status 0 1 }  { srcLayer0Yuv_write fifo_port_we 1 1 } } }
	HwReg_layerEnableFlag_0_val_c { ap_fifo {  { HwReg_layerEnableFlag_0_val_c_din fifo_data_in 1 1 }  { HwReg_layerEnableFlag_0_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerEnableFlag_0_val_c_fifo_cap fifo_update 0 3 }  { HwReg_layerEnableFlag_0_val_c_full_n fifo_status 0 1 }  { HwReg_layerEnableFlag_0_val_c_write fifo_port_we 1 1 } } }
}
