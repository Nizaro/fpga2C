...
HD_PWD='/home/nothon/fpga2C/ZTurnV2/ZTurnV2.runs/main_design_iobuf_I2C0_SDA_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_iobuf_I2C0_SDA_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_iobuf_I2C0_SDA_0.tcl
