...
HD_PWD='/home/nothon/fpga2C/ZTurnV2/ZTurnV2.runs/main_design_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_xbar_1.tcl
