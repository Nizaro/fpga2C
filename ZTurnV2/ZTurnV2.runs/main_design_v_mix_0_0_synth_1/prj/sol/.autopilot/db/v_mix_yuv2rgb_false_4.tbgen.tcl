...
set portList { 
	...
	{ outLayer0_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ outLayer0_fifo_cap sc_in sc_lv 3 signal 4 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0Yuv", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_82", "Port" : "srcLayer0Yuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "outLayer0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_82", "Port" : "outLayer0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_895_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_82", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_82.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0Yuv { ap_fifo {  { srcLayer0Yuv_dout fifo_data_in 0 24 }  { srcLayer0Yuv_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0Yuv_fifo_cap fifo_update 0 3 }  { srcLayer0Yuv_empty_n fifo_status 0 1 }  { srcLayer0Yuv_read fifo_port_we 1 1 } } }
	...
	outLayer0 { ap_fifo {  { outLayer0_din fifo_data_in 1 24 }  { outLayer0_num_data_valid fifo_status_num_data_valid 0 3 }  { outLayer0_fifo_cap fifo_update 0 3 }  { outLayer0_full_n fifo_status 0 1 }  { outLayer0_write fifo_port_we 1 1 } } }
}
