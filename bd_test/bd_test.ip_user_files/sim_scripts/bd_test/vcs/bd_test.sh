...
design_libs=(xpm xil_defaultlib fifo_generator_v13_2_10 xlconcat_v2_1_6)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bd_test xil_defaultlib.glbl -o bd_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bd_test_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nothon/fpga2C/bd_test/bd_test.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key bd_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bd_test_simv.daidir vcs_lib c.obj)
