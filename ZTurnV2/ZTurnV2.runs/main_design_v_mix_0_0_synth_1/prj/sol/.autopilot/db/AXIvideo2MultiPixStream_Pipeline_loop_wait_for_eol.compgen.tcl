...
eval "cg_default_interface_gen_dc { \
    id 233 \
    name axi_data_18_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_18_reload \
    op interface \
    ports { axi_data_18_reload { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln3150 \
    op interface \
    ports { select_ln3150 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 243 \
    name axi_data_19_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_19_out \
    op interface \
    ports { axi_data_19_out { O 24 vector } axi_data_19_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 244 \
    name axi_last_23_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_last_23_out \
    op interface \
    ports { axi_last_23_out { O 1 vector } axi_last_23_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName main_design_v_mix_0_0_flow_control_loop_pipe_sequential_init_U
set CompName main_design_v_mix_0_0_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix main_design_v_mix_0_0_ \
}"
} else {
