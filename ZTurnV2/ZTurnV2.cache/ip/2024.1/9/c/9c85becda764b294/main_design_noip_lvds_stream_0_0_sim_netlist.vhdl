...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_noip_lvds_stream is
  port (
    ...
    s00_axis_tready : out STD_LOGIC;
    lvds_sync_word : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_noip_lvds_stream is
  ...
  signal \bitslip[3]_i_16_n_0\ : STD_LOGIC;
  signal \bitslip[3]_i_17_n_0\ : STD_LOGIC;
  signal \bitslip[3]_i_18_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_DState[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_onehot_DState[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_onehot_DState[8]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_onehot_DState[8]_i_4\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \bitslip[2]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bitslip[2]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bitslip[3]_i_12\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bitslip[3]_i_13\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bitslip[3]_i_15\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bitslip[3]_i_16\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bitslip[3]_i_17\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bitslip[3]_i_18\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bitslip[3]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \bitslip[3]_i_5\ : label is "soft_lutpair3";
...
\FSM_onehot_DState[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
\FSM_onehot_DState[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \bitslip[3]_i_4_n_0\,
      O => \FSM_onehot_DState[8]_i_1_n_0\
    );
\FSM_onehot_DState[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE00"
    )
        port map (
...
\FSM_onehot_DState[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \bitslip[3]_i_11_n_0\,
      I2 => \FSM_onehot_DState_reg_n_0_[6]\,
      I3 => lvds_sync_word(6),
      I4 => \FSM_onehot_DState_reg_n_0_[3]\,
      I5 => \FSM_onehot_DState[8]_i_5_n_0\,
      O => \FSM_onehot_DState[8]_i_3_n_0\
    );
\FSM_onehot_DState[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFEE"
    )
        port map (
      I0 => \FSM_onehot_DState_reg_n_0_[8]\,
      I1 => \FSM_onehot_DState_reg_n_0_[5]\,
      I2 => \FSM_onehot_DState[8]_i_7_n_0\,
      I3 => \bitslip[3]_i_17_n_0\,
...
\bitslip[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => \bitslip[3]_i_8_n_0\,
...
\bitslip[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => lvds_sync_word(7),
      I4 => lvds_sync_word(6),
      I5 => \bitslip[3]_i_5_n_0\,
      O => findbitslip(2)
    );
\bitslip[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\bitslip[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\bitslip[3]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0088008800F00000"
        ...
        port map (
      I0 => \bitslip[3]_i_16_n_0\,
      I1 => lvds_sync_word(2),
      I2 => \bitslip[3]_i_17_n_0\,
      I3 => \bitslip[3]_i_18_n_0\,
      I4 => lvds_sync_word(6),
      I5 => lvds_sync_word(4),
...
\bitslip[3]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\bitslip[3]_i_16\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
      ...
      I2 => lvds_sync_word(7),
      I3 => lvds_sync_word(0),
      O => \bitslip[3]_i_16_n_0\
    );
\bitslip[3]_i_17\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
      ...
      I2 => lvds_sync_word(0),
      I3 => lvds_sync_word(5),
      O => \bitslip[3]_i_17_n_0\
    );
\bitslip[3]_i_18\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\bitslip[3]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
\bitslip[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BFFFFFFFBCFFFFFF"
    )
        port map (
      I0 => \bitslip[3]_i_12_n_0\,
      I1 => lvds_sync_word(4),
      I2 => lvds_sync_word(2),
      I3 => lvds_sync_word(6),
      I4 => lvds_sync_word(7),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  port (
    lvds_clk_div : in STD_LOGIC;
    lvds_sync_word : in STD_LOGIC_VECTOR ( 7 downto 0 );
    lvds_data_word : in STD_LOGIC_VECTOR ( 31 downto 0 );
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_noip_lvds_stream
     port map (
      ...
      lvds_sync_word(7 downto 0) => lvds_sync_word(7 downto 0),
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
      m00_axis_tdata(0) => \^m00_axis_tdata\(30),
      m00_axis_tlast => \^m00_axis_tlast\,
