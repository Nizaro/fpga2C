...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ex_sim xil_defaultlib.ex_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ex_sim -key {Behavioral:sim_basic_mst_active__pt_slv__slv_passive:Functional:ex_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/ex_sim.protoinst" -log simulate.log
}
