...
HD_PWD='/home/nothon/fpga2C/ip_repo/noip_lvds_stream/edit_noip_lvds_stream_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log noip_lvds_stream.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source noip_lvds_stream.tcl -notrace
