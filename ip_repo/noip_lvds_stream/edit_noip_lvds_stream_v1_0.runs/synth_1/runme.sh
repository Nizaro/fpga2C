...
HD_PWD='/home/nothon/fpga2C/ip_repo/noip_lvds_stream/edit_noip_lvds_stream_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log noip_lvds_stream.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source noip_lvds_stream.tcl
