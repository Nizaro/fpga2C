...
generate_target simulation [get_files "../proj/$design_name_full/$design_name_full.srcs/sources_1/bd/design_1/design_1.bd"]

#-----------------------------------------------------------
# Add HDL testbench to design
#-----------------------------------------------------------
puts "Adding HDL testbench to the design..."
set tb_suffix _tb
set fpga_top_tb "$design_name_full$top_suffix$tb_suffix.v"
puts "NOTE: Using $fpga_top_tb for top level testbench"
add_files -norecurse -fileset sim_1 "../tb/$fpga_top_tb"
