...
architecture rtl of main_design_v_mix_0_0_fifo_w1_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component main_design_v_mix_0_0_fifo_w1_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_main_design_v_mix_0_0_fifo_w1_d2_S_ShiftReg : main_design_v_mix_0_0_fifo_w1_d2_S_ShiftReg
    generic map (
...
architecture rtl of main_design_v_mix_0_0_fifo_w1_d2_S_ShiftReg is
