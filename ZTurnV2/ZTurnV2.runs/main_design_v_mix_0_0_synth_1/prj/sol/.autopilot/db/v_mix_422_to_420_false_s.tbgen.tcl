...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "out422", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_420_false_Pipeline_VITIS_LOOP_508_2_fu_62", "Port" : "out422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "out420", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_420_false_Pipeline_VITIS_LOOP_508_2_fu_62", "Port" : "out420", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_506_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_420_false_Pipeline_VITIS_LOOP_508_2_fu_62", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_420_false_Pipeline_VITIS_LOOP_508_2_fu_62.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	out422 { ap_fifo {  { out422_dout fifo_data_in 0 24 }  { out422_num_data_valid fifo_status_num_data_valid 0 3 }  { out422_fifo_cap fifo_update 0 3 }  { out422_empty_n fifo_status 0 1 }  { out422_read fifo_port_we 1 1 } } }
	height_val { ap_stable {  { height_val in_data 0 12 } } }
	width_val { ap_stable {  { width_val in_data 0 12 } } }
	out420 { ap_fifo {  { out420_din fifo_data_in 1 24 }  { out420_num_data_valid fifo_status_num_data_valid 0 3 }  { out420_fifo_cap fifo_update 0 3 }  { out420_full_n fifo_status 0 1 }  { out420_write fifo_port_we 1 1 } } }
}
