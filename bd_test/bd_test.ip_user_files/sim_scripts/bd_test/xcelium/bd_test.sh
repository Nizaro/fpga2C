...
#
# Script generated by Vivado on Fri Aug 09 15:54:13 CEST 2024
...
#
# Usage        : bd_test.sh
#                bd_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bd_test.sh [-reset_run]
#                bd_test.sh [-reset_log]
#                bd_test.sh [-help]
#
...
#                script (type 'bd_test.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname fifo_generator_v13_2_10 -libname xlconcat_v2_1_6 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib fifo_generator_v13_2_10 xlconcat_v2_1_6)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bd_test.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bd_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bd_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bd_test -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nothon/fpga2C/bd_test/bd_test.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bd_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bd_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bd_test.sh [-help]\n\
Usage: bd_test.sh [-step]\n\
Usage: bd_test.sh [-lib_map_path]\n\
Usage: bd_test.sh [-reset_run]\n\
Usage: bd_test.sh [-reset_log]\n\
Usage: bd_test.sh [-keep_index]\n\
Usage: bd_test.sh [-noclean_files]\n\n\
