...
#
# Script generated by Vivado on Wed Jul 10 13:40:43 CEST 2024
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_17 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_17)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ex_sim.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../axi_vip_0_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../axi_vip_0_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../axi_vip_0_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../bd/ex_sim/ip/ex_sim_axi_vip_mst_0/sim/ex_sim_axi_vip_mst_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../axi_vip_0_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
