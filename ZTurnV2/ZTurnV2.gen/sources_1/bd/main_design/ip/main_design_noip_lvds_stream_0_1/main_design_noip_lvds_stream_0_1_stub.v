...
module main_design_noip_lvds_stream_0_1(lvds_clk, lvds_sync, lvds_data, trigger0, 
  monitor0, monitor1, fifo_srst, fifo_full, fifo_din, fifo_wr_en, fifo_empty, fifo_dout, 
...
/* synthesis syn_black_box black_box_pad_pin="lvds_sync,lvds_data[0:3],trigger0,monitor0,monitor1,fifo_srst,fifo_full,fifo_din[63:0],fifo_wr_en,fifo_empty,fifo_dout[31:0],fifo_rd_en,s00_axis_aresetn,s00_axis_tready,s00_axis_tdata[31:0],s00_axis_tstrb[3:0],s00_axis_tlast,s00_axis_tvalid,m00_axis_aclk,m00_axis_aresetn,m00_axis_tvalid,m00_axis_tdata[31:0],m00_axis_tstrb[3:0],m00_axis_tlast,m00_axis_tready" */
/* synthesis syn_force_seq_prim="lvds_clk" */
/* synthesis syn_force_seq_prim="s00_axis_aclk" */;
  input lvds_clk /* synthesis syn_isclock = 1 */;
  input lvds_sync;
  input [0:3]lvds_data;
  output trigger0;
  input monitor0;
