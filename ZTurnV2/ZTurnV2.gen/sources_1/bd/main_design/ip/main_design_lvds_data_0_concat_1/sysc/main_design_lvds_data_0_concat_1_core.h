...
#ifndef _main_design_lvds_data_0_concat_1_core_h_
#define _main_design_lvds_data_0_concat_1_core_h_
...
class main_design_lvds_data_0_concat_1_core : public sc_module 
{
    public: 
       main_design_lvds_data_0_concat_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(main_design_lvds_data_0_concat_1_core);
    ...
    virtual ~main_design_lvds_data_0_concat_1_core() = default;
