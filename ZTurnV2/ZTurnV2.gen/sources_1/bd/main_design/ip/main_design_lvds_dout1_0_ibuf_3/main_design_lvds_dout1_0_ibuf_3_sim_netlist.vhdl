...
-- Command     : write_vhdl -force -mode funcsim -rename_top main_design_lvds_dout1_0_ibuf_3 -prefix
--               main_design_lvds_dout1_0_ibuf_3_ main_design_lvds_clkin_0_ibuf_1_sim_netlist.vhdl
...
entity main_design_lvds_dout1_0_ibuf_3_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of main_design_lvds_dout1_0_ibuf_3_util_ds_buf : entity is 1;
end main_design_lvds_dout1_0_ibuf_3_util_ds_buf;

architecture STRUCTURE of main_design_lvds_dout1_0_ibuf_3_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity main_design_lvds_dout1_0_ibuf_3 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of main_design_lvds_dout1_0_ibuf_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of main_design_lvds_dout1_0_ibuf_3 : entity is "main_design_lvds_clkin_0_ibuf_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of main_design_lvds_dout1_0_ibuf_3 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of main_design_lvds_dout1_0_ibuf_3 : entity is "util_ds_buf,Vivado 2024.1";
end main_design_lvds_dout1_0_ibuf_3;

architecture STRUCTURE of main_design_lvds_dout1_0_ibuf_3 is
...
begin
U0: entity work.main_design_lvds_dout1_0_ibuf_3_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
