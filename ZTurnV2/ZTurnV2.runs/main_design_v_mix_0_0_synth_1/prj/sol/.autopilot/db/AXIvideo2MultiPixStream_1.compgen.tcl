...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer0_din { O 24 vector } srcLayer0_num_data_valid { I 3 vector } srcLayer0_fifo_cap { I 3 vector } srcLayer0_full_n { I 1 bit } srcLayer0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 62 \
    name HwReg_layerEnableFlag_0_val_c14 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerEnableFlag_0_val_c14 \
    op interface \
    ports { HwReg_layerEnableFlag_0_val_c14_din { O 1 vector } HwReg_layerEnableFlag_0_val_c14_num_data_valid { I 3 vector } HwReg_layerEnableFlag_0_val_c14_fifo_cap { I 3 vector } HwReg_layerEnableFlag_0_val_c14_full_n { I 1 bit } HwReg_layerEnableFlag_0_val_c14_write { O 1 bit } } \
} "
}
